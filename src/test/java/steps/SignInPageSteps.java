...
public class SignInPageSteps extends WebBase {
    ...
    public void user_enter_valid_email_address_or_phone_number_in_username_field(String email) {
    ...
    @Given("user enter valid password {string} in password Field")
    public void user_enter_valid_password_in_password_field(String password) throws InterruptedException {
